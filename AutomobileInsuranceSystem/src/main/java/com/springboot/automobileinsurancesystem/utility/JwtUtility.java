package com.springboot.automobileinsurancesystem.utility;
...
public class JwtUtility {
    ...
    private final String SECRET_KEY = "tata_hyundai_kia_morris_suzuki_toyota";
    ...
    private String createToken(Map<String, Object> claims, String subject) {
        ...
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 60*60*24*1000)) // 1 day conversion to millisecond
